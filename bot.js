...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      botRegex = /^\/mak/;  botRegexDL = /^\/DDL/i;botRegexSalt = /^\/mark/;botRegexRules = /^\/rules/
      botRegexAd=/^\/advance/;botRegexGTA = /^\/gta/; botRegexSC = /^\/helpy/i; botODB = /(.*\s+)(.*odb)(\s+.*)/i; botDuck = /^\/duck/;
